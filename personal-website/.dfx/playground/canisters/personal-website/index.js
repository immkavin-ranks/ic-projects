...
import { idlFactory } from './personal-website.did.js';
export { idlFactory } from './personal-website.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PERSONAL_WEBSITE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./personal-website.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the personal-website canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./personal-website.did.js")._SERVICE>}
 */
export const personal_website = createActor(canisterId);
